...
if __name__ == "__main__":
    ...
    while True:
        led_value = pot.value * div
        print((led_value, ))
        print(led_value)

        if led_value <= 255:
            rgb_led.setColorRGB(0, int(led_value), 0, 0)

        elif (led_value > 255) and led_value <= (2 * 255):
            rgb_led.setColorRGB(0, 0, int(led_value-255), 0)

        else:
            rgb_led.setColorRGB(0,0,0,int(led_value-(2*255)))
